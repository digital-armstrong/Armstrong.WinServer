// rep: https://github.com/RuvenSalamon/IP-MaskedTextBox
...
{
    /// <summary>
    /// Логика взаимодействия для IpMaskTextBox.xaml
    /// </summary>
    public partial class IpMaskTextBox : UserControl
    {
        ...
        #region constructors
        public IpMaskTextBox()
        {
            InitializeComponent();
        }
        public IpMaskTextBox(byte[] bytesToFill)
        {
            InitializeComponent();
